...
{
    public class MPosstatus : IBinarizable, ICanReadFromRecordBuffer
    {
        [QuerySqlField(Name = "posstatus")] public long Posstatus { get; set; }
        ...
        {
            writer.WriteLong(nameof(Posstatus), Posstatus);
        ...
        {
            Posstatus = reader.ReadLong(nameof(Posstatus));
