...
{
    public class MAveragecostflag : IBinarizable, ICanReadFromRecordBuffer
    {
        [QuerySqlField(Name = "averagecostflag")] public long Averagecostflag { get; set; }
        ...
        {
            writer.WriteLong(nameof(Averagecostflag), Averagecostflag);
        ...
        {
            Averagecostflag = reader.ReadLong(nameof(Averagecostflag));
